...
SALKYN_DOCUMENTS = [
    {
        ...
        "notes": (
            "Участок 0,95 га: г. Бишкек, Октябрьский р-н, ул. Чокана Валиханова, д. 7. "
            "ИКЗУ: 1-04-15-0037-0061. Выписка ЕГРПНИ от 12.09.2025: обременений и ареста нет. "
            "Целевое назначение соответствует строительству жилого комплекса."
        ),
        "file_url": None,
        "is_public": True,
    },
    ...
    },
    {
        ...
        "notes": (
            "Выдано только на 1 этап: архитектурные и конструктивные решения. "
            "Заключение по инженерным коммуникациям (2 этап) отсутствует — "
            "застройщику необходимо предоставить согласно ПКМКР №114 от 06.08.2021."
        ),
        "file_url": None,
        "is_public": True,
    },
    {
        ...
        "issued_date": None,
        "notes": (
            "Объект в стадии строительства. Планируемая сдача — 2 квартал 2028 года. "
            "Разрешение на ввод оформляется после завершения строительства."
        ),
        "file_url": None,
        "is_public": True,
    },
    {
        ...
        "issued_date": None,
        "notes": (
            "Долевая собственность с регистрацией в ГРС. "
            "Условия: первоначальный взнос 30%, рассрочка до 28 месяцев, бартер +$50/м² (мин. взнос 40%)."
        ),
        "file_url": None,
        "is_public": True,
    },
